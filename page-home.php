...
get_header(); ?>
            	...
            	<div class="container clearfix">
                	<div class="row">
                        ...
                        <div class="col-sm-7 hero-text">
                        	<h1>iTeach WordPress</h1>
                            <p class="lead">Earn an extra Rs.20000 - Rs.50000 a Month by Learning to Code Your Very Own Responsive &amp; Custom WordPress Websites with Bootstrap.</p>
        ...
        <section id="boost-income">
        	<div class="container">
                ...
                <p class="lead">Wherther you&rsquo;re a freelance designer, entrepreneur, employee or a company, code hobbyist, or looking for a new career&mdash; this gives you an immensely valuable skill that will enable you to either: </p>
                <div class="row">
                	<div class="col-sm-6">
        ...
        <section id="course-features">
            <div class="container">
                ...
                <div class="section-header">
                    <img src="<?php bloginfo('stylesheet_directory'); ?>/assets/img/icon-pad.png" alt="An icon of a rocket">
            ...
            <div class="container">
                ...
                <div class="row">
                    ...
                    <div class="col-sm-4">
                        ...
                        <img width="140" height="140" src="<?php bloginfo('stylesheet_directory'); ?>/assets/img/icon-design.png" alt="Design" />				
                        <h3>Sexy &#038; Modern Design</h3>
                        <p><p>You get to work with a modern, professional quality design &amp; layout.</p>
        </p>
                    </div><!-- end col -->
                    ...
                    <div class="col-sm-4">
                        ...
                        <img width="140" height="140" src="<?php bloginfo('stylesheet_directory'); ?>/assets/img/icon-code.png" alt="Code" />				
                        <h3>Quality HTML5 &#038; CSS3</h3>
                        <p><p>You&#8217;ll learn how hand-craft a stunning website with valid, semantic and beautiful HTML5 &amp; CSS3.</p>
        </p>
                    </div><!-- end col -->
                                
                    <div class="col-sm-4">
                        
                        <img width="140" height="140" src="<?php bloginfo('stylesheet_directory'); ?>/assets/img/icon-cms.png" alt="CMS" />				
                        <h3>Easy-to-use CMS</h3>
                        <p><p>Allow your clients to easily update their websites by converting your static websites to dynamic websites, using WordPress.</p>
        </p>
                    </div><!-- end col -->
            ...
            <div class="container">
                <div class="row">
                    <div class="col-sm-8 col-sm-offset-2">
                        ...
                        <iframe width="100%" height="415" src="https://www.youtube.com/embed/MvqxVajsAlo" frameborder="0" allowfullscreen></iframe>
                    </div><!-- end col -->
                </div><!-- row -->
            </div><!-- container -->
        </section><!-- featurette -->
            ...
            <div class="container">
                <div class="row">
                    <div class="col-sm-8 col-md-6">
                        <div class="row">
                            <div class="col-lg-8">
                                <h2>Your Instructor <small>Kiran Dash</small></h2>
                            </div><!-- end col -->
                            
                            <div class="col-lg-4">
                                
                                <a href="https://twitter.com/TheKiranDash" target="_blank" class="badge social twitter"><i class="fa fa-twitter"></i></a>
                                
                                <a href="https://facebook.com/thekirankumardash" target="_blank" class="badge social facebook"><i class="fa fa-facebook"></i></a>
                                
                                <a href="https://plus.google.com/+KiranDash" target="_blank" class="badge social gplus"><i class="fa fa-google-plus"></i></a>
                                                        
                            </div><!-- end col -->
                            
                        </div><!-- row -->
                        
                        <p class="lead">A highly skilled professional, Kiran Dash is a passionate and experienced web designer, developer, blogger and digital entrepreneur.</p>
                        
                        Hailing from The State of Gods (Orissa, India), Kiran made the trek to the South India (Hyderabad, India) to educate and equip himself with the necessary skills to become a spearhead in his trade of solving problems on the web, crafting design solutions, and speaking in code.<br />
        <br />
        Kiran&#039;s determination and love for what he does has landed him in some pretty interesting places with some neat people. He&#039;s had the privilege of working with, and providing solutions for, numerous businesses, big &amp; small, across the Americas.<br />
        <br />
        Kiran builds custom websites, and provides design solutions for a wide-array of clientele at his company, Brightside Studios. He regularly blogs about passive income, living your life to the fullest, and provides premium quality web design tutorials and courses for tens of thousands of amazing people desiring to master their craft.				
                        <hr>
